    ...
    public static class PaymentMappingExtensions
    {
        ...
        public static PaymentDetail? ToPaymentDetail(this InvoicePayment? payment, CardPayment? cardPayment = null)
        {
            ...
            if (cardPayment != null)
            {
                ...
                detail.CardPaymentNumber = cardPayment.CardNumber.ToString();
                detail.CardPaymentDetails = cardPayment.AuthCode.ToString(); // Assuming AuthCode acts as the detail/reference
